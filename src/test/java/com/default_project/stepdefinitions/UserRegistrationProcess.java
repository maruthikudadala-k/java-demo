...
import com.default_project.pages.UserRegistrationProcessPage;
...
userRegistrationProcessPage.canUserLogin(email);
}
...
userRegistrationProcessPage.isEmailSpaceErrorDisplayed();
}
@Then("the user should see the error message indicating that the passwords do not match")
public void the_user_should_see_the_error_message_indicating_that_the_passwords_do_not_match() {
userRegistrationProcessPage.isPasswordMismatchErrorDisplayed();
}
@Then("the user should see the error message indicating that the email must contain more than three characters")
public void the_user_should_see_the_error_message_indicating_that_the_email_must_contain_more_than_three_characters() {
userRegistrationProcessPage.isEmailLengthErrorDisplayed();
}
...
userRegistrationProcessPage.isPasswordLengthErrorDisplayed();
}