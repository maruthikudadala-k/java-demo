...
Scenario Outline: User Registration Process
  ...
  Scenario Outline: User Registration Process
    ...
    And I enter "<confirmation>" in the confirmation field
    And I click the "Register" button
    Then the system should create the account and redirect to the success page
    And the user should receive a confirmation email in the inbox
...
Scenario Outline: User Registration Process
  ...
  Scenario Outline: User Registration Process
    Given the user is on the Registration Page
    When the user enters "<email>"
    And the user enters a password that includes letters, numbers, and special characters "<password>"
    And the user confirms the password "<confirm_password>"
    And the user clicks the "Register" button
    Then the user should see a success message
  ...
  Scenario Outline: User Registration Process
    Given the user is on the Registration Page
    When I enter "<email>"
    And I enter a password that meets the maximum length requirement
    And I confirm the password in the confirmation field
    And I click the "Register" button
    ...
    Examples:
      | email               | password                      | confirmation_password     |
      | krishna@gmail.com   | <max_length_password>        | <max_length_password>     |
  ...
  @valid-password
  Scenario Outline: Validate Password Without Spaces
    Given the user is on the Registration Page
    When the user enters "<password>" in the password field
    Then the password field should accept the valid password without spaces
...
@validate_email_and_password_fields
Scenario Outline: User Registration Process
  Given the user is on the Registration Page
  ...
  And the user enters "<password>" in the password field
  Then the user should be able to interact with the email field
  And the user should be able to interact with the password field
  And the user should be able to interact with the confirmation password field
...
Scenario Outline: User Registration Process
  ...
  @validate_email_password_fields
  Scenario Outline: Validate that the email and password fields are accessible and usable on mobile devices
  ...
  Scenario Outline: User Registration with Invalid Email
    ...
    And I confirm the password as "<confirmation>"
    And I click the "Register" button
    Then the email and password fields should retain their values

    Examples:
      | email     | password            | confirmation         |
      | abc@      | ValidPassword123    | ValidPassword123     |

  @verify_fields_cleared_after_registration
  Scenario Outline: User Registration Process
    Given the user is on the Registration Page
    When I enter "<email>" in the email field
    And I enter "<password>" in the password field
...
Scenario Outline: User Registration Fails with Already Registered Email
  Given the user is on the Registration Page
  When I enter "<email>"
  And I enter "<password>"
  And I enter "<confirmation>"
  ...
  Scenario Outline: User Registration Process
    ...
    Then the tooltip for the email field provides information about valid email format
    When the user hovers over the password field
    Then the tooltip for the password field provides information about password requirements
    When the user hovers over the confirmation password field
    Then the tooltip for the confirmation password field provides information about matching passwords
  ...
  Scenario Outline: User Registration Process with Exceeding Password Length
    ...
    And the user enters "<confirmation>" in the confirmation field
    When the user clicks the "Register" button
    Then the user should see an error message indicating the password exceeds the maximum length
  ...
  Scenario Outline: Validate Required Fields on Registration Page
...
Scenario Outline: User Registration with Empty Password
  ...
  Scenario Outline: User Registration Process with Empty Confirmation Password
    ...
    And I leave the confirmation password field empty
    And I click the "Register" button
    Then an error message should be displayed indicating that the confirmation password field is required
...
Scenario Outline: User Registration Process with Invalid Email Domain
  ...
  And I enter "<confirmation>"
  And I click the "Register" button
  Then the system displays an error message for the invalid email domain
  And the email field is highlighted to indicate the error
  ...
  Scenario Outline: User Registration with Invalid Email Format
    ...
    And I confirm the password "<confirmation>"
    And I click the Register button
    Then the system should display an error message for the invalid email format
    And the email field should be highlighted to indicate the error
  ...
  @invalid-password
  Scenario Outline: Validate Password Without Uppercase Letters
    Given the user is on the Registration Page
    When I enter "<email>"
    And I enter "<password>"
    And I confirm the password "<confirmation>"
...
Scenario Outline: User Registration Process with Password Missing Lowercase Letters
  Given the user is on the Registration Page
  When I enter "<email>" in the email field
  And I enter "<password>" in the password field
  And I enter "<confirmation>" in the confirmation field
  ...
  Scenario Outline: User Registration Process with Invalid Password
    ...
    And the user confirms the password with "<confirmation>"
    And the user clicks the Register button
    Then the system displays an error message indicating the password must contain numbers
  ...
  @invalid-password
  Scenario Outline: User Registration Process with Password Lacking Special Characters
    Given the user is on the Registration Page
    When I enter "<email>" in the email field
    And I enter "<password>" in the password field
    And I enter "<confirmation>" in the confirmation field
  ...
  @empty_password
  Scenario Outline: Validate Registration Fails with Empty Password
    Given the user is on the Registration Page
    When I enter "<email>" in the email field
    And I leave the password field empty
    And I leave the confirmation password field empty
  ...
  @empty_confirmation_password
  Scenario Outline: User Registration Fails When Confirmation Password is Empty
    Given the user is on the Registration Page
    When I enter "<email>" in the email field
    And I enter "<password>" in the password field
    And I leave the confirmation password field empty
  ...
  @invalid-password
  Scenario Outline: Validate Registration Fails with Short Password
    Given the user is on the Registration Page
    When I enter "<email>"
    And I enter "<password>"
    And I confirm the password "<confirmation>"
  ...
  @invalid-password-length
  Scenario Outline: User Registration Process with Password Exceeding Maximum Length
    Given the user is on the Registration Page
    When I enter "<email>" in the email field
    And I enter "<password>" in the password field
    And I confirm "<confirmation>" in the confirmation field
...
Scenario Outline: User Registration Process with Invalid Password
  ...
  And I enter "<confirmation>"
  And the user clicks the Register button
  Then the system displays an error message indicating the password contains invalid characters
  And the password field is highlighted to indicate the error
  ...
  @invalid-email
  Scenario Outline: Validate Registration Failure with Invalid Email
    When I enter "<email>" in the email field
    And I enter "<password>" in the password field
    And I confirm "<confirmation>" in the confirmation field
    And I click the "Register" button
